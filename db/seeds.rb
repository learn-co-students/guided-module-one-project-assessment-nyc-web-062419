...
## If you would like to delete all of your database data and then repopulate it, un-comment out the following lines and run 'rake db:seed' in your terminal again.
